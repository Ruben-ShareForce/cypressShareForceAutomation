describe("Export Employee Data", () => {
    ...
    it("can export employee data successfully", () => {
        cy.visit("/");
        cy.wait(500);
        ...
        cy.get("a.bg-file-trigger[data-url='/app/employees/export/employees/?']")
            .should("be.visible").click();

        cy.wait(2000);
        
        const downloadPath = 'cypress/downloads/Employees.xlsx';
        cy.wait(2500);
